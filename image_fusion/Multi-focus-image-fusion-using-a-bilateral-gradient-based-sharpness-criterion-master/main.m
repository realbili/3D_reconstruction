...
MA = double(imread(['E:\research\A_FOCUS_Data\4DLightFieldDataset_PSF\test\7\input\1.bmp']));
MB = double(imread(['E:\research\A_FOCUS_Data\4DLightFieldDataset_PSF\test\7\input\2.bmp']));
...
imwrite(uint8(MF), ['E:\research\A_FOCUS_Data\4DLightFieldDataset_PSF\test\7\100\3_BGSC.bmp']);

%--------------------------------------Ñ­»·Ìå--------------------------------------------%

for K = 3:100
    % Load two images with different focus levels
MA = double(imread(['E:\research\A_FOCUS_Data\4DLightFieldDataset_PSF\test\7\100\3_BGSC.bmp']));
MB = double(imread(strcat('E:\research\A_FOCUS_Data\4DLightFieldDataset_PSF\test\7\input\', num2str(K) ,'.bmp')));
