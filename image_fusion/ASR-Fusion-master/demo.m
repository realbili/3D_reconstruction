...
image_input1=imread('E:\research\image_fusion\1\ASR-Fusion-master\Data\a01_1.tif');
image_input2=imread('E:\research\image_fusion\1\ASR-Fusion-master\Data\a01_2.tif');
...
imwrite(image_fusion,['E:\research\demo.bmp']);
...
% for K = 3:30
%     
% image_input1=imread('E:\research\1_ASR_30.bmp');
% image_input2=imread(strcat('E:\research\boxes_30\', num2str(K) ,'.bmp'));
% 
% 
% % if size(image_input1)~=size(image_input2)
% %     error('two images are not the same size.');
...
% image_fusion=uint8(imgf);
% %figure;imshow(image_fusion);
% imwrite(image_fusion,['E:\research\1_ASR_30.bmp']);
% end
